...
namespace KihonEngine.Studio.Controls
{
    ...
    public class BrowseForFolder
    {
        ...
        public string SelectFolder(string caption, string initialPath, System.Windows.Window parent)
        {
            var windowHandle = new WindowInteropHelper(parent).Handle;
            return SelectFolder(caption, initialPath, windowHandle);
        }
        ...
        public string SelectFolder(string caption, string initialPath, IntPtr parentHandle)
        {
            ...
            bi.ulFlags = BIF_NEWDIALOGSTYLE | BIF_SHAREABLE | BIF_NONEWFOLDERBUTTON;
